...
const LOGOS = [
    { src: "/assets/logos/10.png", alt: "AWS" },
    { src: "/assets/logos/11.webp", alt: "Microsoft" },
    { src: "/assets/logos/12.webp", alt: "Google" },
    { src: "/assets/logos/13.webp", alt: "Oodo" },
];
        ...
        <section className="w-full py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    >
                        Collaborating for Innovation, Delivering Perfection
                    </motion.p>
                    ...
                    >
                        At 4A Tek, we join forces with top technology partners to craft 
                        tailored solutions that drive efficiency, scalability, and business success. 
                        Our commitment to excellence ensures seamless integration, reliability, and measurable impact.
                    </motion.p>
                </div>
